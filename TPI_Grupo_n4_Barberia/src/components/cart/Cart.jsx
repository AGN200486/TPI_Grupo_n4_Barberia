...
const CartList = () => {
    ...
    return (
        /*Envolvemos todo con este div maestro para controlar el centrado Flexbox */
        <div className="barber-cart-page d-flex justify-content-center align-items-center">
